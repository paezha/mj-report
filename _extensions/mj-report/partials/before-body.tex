...
\begin{flushleft}
    \vspace{-7cm}
      ...
      $if(title)$
        {\relscale{2}{\textcolor{white}{$title$}}}\\  
      $endif$
      \vspace{1cm} 
      ...
      $for(by-author)$
        {\relscale{1.5}{\textcolor{Yellow}{$by-author.name.literal$}}} 
          % Needs to iterate by affilitations
          $for(by-author.affiliations)$
            \hskip 10pt{\relscale{1.0}{\textcolor{Yellow}{$by-author.affiliations.name$}}} \par%
          $endfor$ 
      $endfor$
